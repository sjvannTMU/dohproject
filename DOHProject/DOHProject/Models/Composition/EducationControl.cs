...
namespace DOHProject.Models.Composition
{
    ...
    /// 學歷資料
    /// </summary>
    public class EducationControl : IContentMap<EducationControl>
    {
        /// <summary>
        /// 建構元
        /// </summary>
        ...
        public EducationControl(PM.EducationControl content)
        {
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public EducationControl Get(IPublishedContent content)
        {
            if (content != null && content.ContentType.Alias == PM.EducationControl.ModelTypeAlias)
            {
                return new EducationControl((PM.EducationControl)content);
            }
            return new EducationControl();
        }
        /// <summary>
        /// 設定資料元
        /// </summary>
